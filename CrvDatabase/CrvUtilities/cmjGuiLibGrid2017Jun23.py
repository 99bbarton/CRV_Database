...
#
Version = 'v_2012jan12A'
allDiag = 1000      # set cmjDiag to this value to turn on all diagnostic prints
...
class myIndependentWindow(Frame):
    ...
    def buttonAction(self):
      ...
      self.__localJob = self.__module.packWindow(self.__localWindow,0,0).grid() 
