...
##  Modified by cmj2018Aug03... Make the development database default
...
if __name__ == '__main__':
  ...
  parser.add_option('--database',dest='database',type='string',default="development",help='--database = ''production''... send to production database')
