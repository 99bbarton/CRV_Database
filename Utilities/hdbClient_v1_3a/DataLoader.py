# -*- coding: utf-8 -*-
##
## hdbClient_v1_3a... DataLoader
## Modified by cmj2018Mar26 to return error flag if
## a query does not connect to the url.
##
import urllib2
import json
...
class DataQuery:
	...
	try: 
	  ...
	  print("-----------------------> DataLoader::querry - error with urllib2.urlopen(req) \n")
	  data.append(-8888)
	  data.append(-9999)
